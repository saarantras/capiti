...
|---|---|---|---|---|---|---|
| capiti_v2_maxpool | 0.998 | 0.997 | 0.972 | 0.999 | 0.051 | 0.3196 |
...
| class | n | capiti_v2_maxpool | blast_nearest_wt | kmer3_nn | kmer3_lr |
|---|---|---|---|---|---|
| mpnn_positive | 900 | 0.999 | 0.000 | 0.000 | 0.890 |
| ala_scan | 82 | 0.585 | 0.988 | 0.890 | 0.317 |
| combined_ko | 161 | 1.000 | 1.000 | 0.994 | 1.000 |
| family_decoy | 165 | 1.000 | 1.000 | 1.000 | 1.000 |
| perturb30 | 270 | 0.919 | 0.796 | 0.830 | 1.000 |
